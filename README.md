...
```bash
# Clonar repositorio
$ git clone https://github.com/dgcorredorr/ms-quasar-fire-op
...
-Dsonar.projectKey=ms-quasar-fire-op -Dsonar.projectName='ms-quasar-fire-op' -Dsonar.host.url=<SONARQUBE_URL>
```
